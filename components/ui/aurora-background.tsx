...
export const AuroraBackground = ({
  ...
  return (
    <div
      className={cn(
        "transition-bg relative flex min-h-screen flex-col bg-white text-black dark:bg-gray-900 dark:text-white",
        className,
      )}
      {...props}
    >
